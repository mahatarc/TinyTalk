...
from .views import   SignupAPIView, UserProgressAPIView, AnswerQuizAPIView,LoginAPIView,ProtectedAPIView,VerifyEmailAPIView, AdaptiveQuizAPIView,ForgotPasswordView, PasswordResetConfirmView, CheckEmailAPIView
...
urlpatterns = [
    ...
    path('check_email/<str:email>/', CheckEmailAPIView.as_view(), name='check-email'),
]
